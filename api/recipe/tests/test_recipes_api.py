...
def sample_tag(user, name='Main course'):
    """Creating and return a sample tag"""
...
class PrivateRecipeApiTest(TestCase):
    ...
    def test_create_recipe_with_ingredient(self):
        ...
        ingredient1 = sample_ingredient(user=self.user, name='Kiwi')
...
class RecipeImageUploadTests(TestCase):
    ...
    def test_filter_recipe_by_ingredient(self):
        ...
        recipe1 = sample_recipe(user=self.user, title='Rfissa')
        recipe2 = sample_recipe(user=self.user, title='Couscous')
        ...
        recipe3 = sample_recipe(user=self.user, title='Couscous')
